...
classifier=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/Zc0BJ_RpP/model.json',modelLoaded);
...
function gotResult(error,results)
{
    ...
    else
    {
        ...
        {
            document.getElementById("result_hand_gesture_name").innerHTML="&#129304;";
        }
        ...
        {
            document.getElementById("result_hand_gesture_name_2").innerHTML="&#129304;";
        }
